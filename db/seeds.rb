...
person_father = Person.create(name: "João Father", genre: "Male", birthdate: "22/08/1965", race: "white", phone: "12345", cellphone: "54321", naturalness: "Viamão, RS", nationality: "brasileira", address: address)
person_son = Person.create(name: "Lucas Son", genre: "Male", birthdate: "22/08/1995", race: "white", phone: "12345", cellphone: "54321", naturalness: "Viamão, RS", nationality: "brasileira", address: address)
...
person_daughter = Person.create(name: "Maria Daughter", genre: "Female", birthdate: "22/08/1995", race: "white", phone: "12345", cellphone: "54321", naturalness: "Viamão, RS", nationality: "brasileira", address: address)
